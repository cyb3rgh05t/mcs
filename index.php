...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!SecurityManager::validateCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        SecurityManager::logSecurityEvent('csrf_token_mismatch');
    }
}

// Rate Limiting
$client_ip = $_SERVER['REMOTE_ADDR'] ?? 'unknown';
if (!SecurityManager::rateLimitCheck($client_ip, 10, 300)) {
...
// POST-Verarbeitung für jeden Schritt
    ...
    switch ($step) {
        ...
        case 5: // Bestätigung
            try {
                ...
                $errors[] = 'Fehler beim Erstellen der Buchung: ' . $e->getMessage();
...
<head>
    ...
    <title>Termin buchen - MCS Mobile Car Solutions</title>
    <link rel="stylesheet" href="assets/css/style.css">
    <!-- Google Maps wird dynamisch von JavaScript geladen -->
</head>
